...
<div className="p-8 bg-white rounded-xl shadow-lg">
  <h2 className="text-2xl font-bold text-gray-800 mb-6 border-b pb-4">Test Sections</h2>
  <div className="grid grid-cols-1 gap-4">
    ...
    <input
      ...
      onKeyDown={(e) => {
        if (e.key === 'Enter' && e.target.value.trim()) {
          addSection(e.target.value); // Call the new function
          e.target.value = '';
        }
      }}
    />
    <button
      onClick={() => {
        ...
        if (inputElement?.value.trim()) {
          addSection(inputElement.value); // Call the new function
          inputElement.value = '';
        }
      }}
